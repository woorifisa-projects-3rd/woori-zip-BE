    ...
    void findById_존재하는_대출상품을_조회할_수_있다() {
        ...
        assertAll(
                ...
                () -> {
                    ...
                    assertThat(loanGoodsValue.getDescription()).isEqualTo(loanGoods.getDescription());
                    ...
                    assertThat(loanGoodsValue.getLoanGoodsType()).isEqualTo(loanGoods.getLoanGoodsType());
                     }
                );
    }
