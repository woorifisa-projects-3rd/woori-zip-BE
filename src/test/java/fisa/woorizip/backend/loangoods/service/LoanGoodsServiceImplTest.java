        ...
        assertAll(
                ...
                () ->
                        assertThat(response.getRateList().get(0).getId())
                                .isEqualTo(expectedRateList.get(0).getId()),
                () ->
                        assertThat(response.getRateList().get(0).getRateType())
                                .isEqualTo(expectedRateList.get(0).getRateType()),
                () ->
                        assertThat(response.getRateList().get(0).getNormal())
                                .isEqualTo(expectedRateList.get(0).getNormal()),
                () ->
                        assertThat(response.getRateList().get(0).getSpecial())
                                .isEqualTo(expectedRateList.get(0).getSpecial()),
                () ->
                        assertThat(response.getInterestMethod())
                                .isEqualTo(loanGoods.getInterestMethod()),
